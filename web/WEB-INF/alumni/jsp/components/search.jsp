            ...
            <div class="row">
                <div class="col-8">
                    <form class="form-inline" action="AlumniController" method="POST">
                        ...
                        <button type="submit" class="btn btn-outline-success my-2 my-sm-0" name="searchBtn" ><i class="fas fa-search"></i> Search</button>
                ...
                <div class="col" style="text-align: right">
                    <form action="AlumniController" method="POST">
                        <input type="hidden" name="requestType" value="searchAlumni">
                        <button type="submit" class="btn btn-outline-success my-2 my-sm-0" name="resetBtn" ><i class="fas fa-sync-alt"></i> Refresh</button>
                    </form>
                </div>
            </div> 
        </div>
